    ...
    Response.json(
      {
        error: {
          code: "INTERNAL",
          message: "password=secret https://private.invalid",
        },
      },
      { status: 503 },
    ),
